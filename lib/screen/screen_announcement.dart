...
class ScreenAnnouncement extends StatefulWidget {
  const ScreenAnnouncement({super.key});

  @override
  State<ScreenAnnouncement> createState() => _ScreenAnnouncementState();
}

class _ScreenAnnouncementState extends State<ScreenAnnouncement> {
  @override
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            ...
                            Container(
                              color: Colors.red,
                              child: const Text("Result of igtl api reuest to announcement categories container\n"
                                  "dasd\n"
                                  "dasd\n"
                                  "dasd\n"
                                  "dasd\n"
